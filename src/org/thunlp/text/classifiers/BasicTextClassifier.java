...
public class BasicTextClassifier {
    ...
    public void addfiles(String filename) {
        ...
        System.out.println(String.format("addfiles %s", filename));
            ...
            for (int i = 0; i < listFiles.length; ++i) {
                if (listFiles[i].isDirectory()) {
                    ...
                    if (suffix == null ||
                        ...
                        System.out.println(String.format("filteredName add {%s}", listFiles[i].getAbsolutePath()));
                    }
                }
            }
    ...
    public void testfiles(String filename) {
        ...
        for (int i = 0; i < filteredName.size(); ++i) {
            ...
            if (filteredName.get(i).endsWith("eng")) {
                continue;
            }
